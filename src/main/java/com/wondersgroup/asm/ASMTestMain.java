...
public class ASMTestMain {
	...
	public static void main(String []args) 
		...
		//在字节码增强前记录一个Class
		Class <?>beforeASMClass = TEST_CLASS_LOADER.loadClass("com.wondersgroup.asm.ForASMTestClass");
		
		//我们重新装载修改后的类
		TEST_CLASS_LOADER.defineClassByByteArray("com.wondersgroup.asm.ForASMTestClass", asmChangeClassCall());
		Class <?>afterASMClass = TEST_CLASS_LOADER.loadClass("com.wondersgroup.asm.ForASMTestClass");
	...
	private static byte[] asmChangeClassCall() throws IOException {
		ClassReader classReader = new ClassReader("com.wondersgroup.asm.ForASMTestClass");
